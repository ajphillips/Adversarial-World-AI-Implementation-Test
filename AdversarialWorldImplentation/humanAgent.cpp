...
Human::Human(int xLoc, int yLoc, Node startNode){
    item = '`';
    location[0] = xLoc;
    location[1] = yLoc;
...
void Human::moveSpace(int xLoc, int yLoc, Node targetNode){
    location[0] = xLoc;
    location[1] = yLoc;
    currNode = targetNode;
...
void Human::update(Node **wholeMap){
...
int Human::decideMove(){
   //Different for Human and Monster agents
   //Implement different weights
}

int Human::decideDir(int corner, int edge){
...
bool Human::canPickUp(Node cNode){
